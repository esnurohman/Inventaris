                ...
                <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
                    <div class="w-full md:w-1/2">
                        <div class="flex flex-col items-center justify-center md:items-start md:justify-start ">
                            <div class="text-2xl font-bold">Daftar Kategori Barang</div>
                            <div class="text-sm text-slate-400">Semua kategori: 
                                
                                    
                                <span class="font-semibold text-black">
                                {{ $kategoris->count() }}</span> 
                                
                                Hasil</div>
                        </div>
                    </div>
                    <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                        <a href="/dashboard/kategori/create" class="mx-auto">
                    ...
                    <table id="TableList" class="w-full text-sm text-left text-gray-500 ">
                        <thead class="text-xs text-gray-700 uppercase bg-gray-50 ">
                            <tr>
                                ...
                                <th scope="col" class="px-4 py-3">Jenis Kategori Barang</th>
                        ...
                        <tbody>
                            ...
                            <tr class="border-b ">
                                ...
                                <td class="gap-1 px-4 py-3 ">
                                    <form onsubmit="return confirm('Apakah Anda Yakin ?');" action="{{ route('kategori.destroy', $kategori->id) }}" method="POST" class="flex items-center justify-center">
